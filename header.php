    ...
    <div class="container">
      <div class="row">
        <div class="col-sm-3 col-md-2">
          <div class="logo"> <a href="index.php"><img src="assets/images/logo.png" height="50" width="100" alt="image"/> <h5 class="nav-h5">CAR.com</h5></a> </div>
        </div>
...
echo "Welcome To Car rental portal";
  ...
  <!-- Navigation -->
  <nav id="navigation_bar" class="navbar navbar-default bg-danger">
    <div class="container">
